export const faculties = [
  {
    ...
    departments: [
      ...
      },
      {
        id: "science-physics",
        name: "物理学科",
        body: "量子力学・統計力学・量子物性を軸に、物質のふるまいを深く探究する。",
      },
      {
  ...
  },
  {
    ...
    departments: [
      ...
      },
      {
        ...
        name: "デザイン科",
        body: "情報設計・UI/UX・視覚表現を横断し、人に届く体験を形にする。",
      },
    ],
  },
  {
    ...
    description:
      "神学・宗教学・哲学倫理学の3学科で構成される神学部。聖典解釈・宗教哲学・比較宗教学を通じて人間の精神的営みを深く探究し、多様な文化・信仰・価値観を理解し対話できる人材を育成します。",
    departments: [
      {
        id: "theology-theology",
        name: "神学科",
        body: "聖典解釈学・組織神学・歴史神学を柱に、信仰の知的探究を深める。",
      },
      {
    ...
    departments: [
      {
        ...
        name: "政治学科",
        body: "政治理論・比較政治・行政学を軸に、民主主義と統治のしくみを探究する。",
      },
      {
  ...
  },
  {
    ...
    description:
      "美術・音楽・デザイン史・芸術学の4学科で構成される芸術学部。実践と理論の両面から創造力と批評眼を兼ね備えた芸術家・研究者を育成します。",
    departments: [
      {
        id: "arts-fine-arts",
        name: "美術学科",
        body: "絵画・彫刻・版画・映像表現を横断し、芸術の本質と実践を深く学ぶ。",
      },
      {
        id: "arts-music",
        name: "音楽学科",
