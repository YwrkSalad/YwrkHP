export const history = [
  {
    year: "1948",
    event: "やわらか大学設立。理学部・農学部の2学部でスタート。",
  },
  {
    year: "1965",
    event: "工学部を設置。工業化社会を支える技術者育成を開始。",
  },
  {
    year: "1982",
    event: "情報科学部を設置。計算機科学・AIの先駆的研究に着手。",
  },
  {
    year: "1994",
    event: "大学院を設置。研究科2専攻を開設し、博士人材の育成を本格化。",
  },
  {
    year: "2007",
    event: "医学部を設置。医学科・保健学科で地域医療・高度医療人を育成。",
  },
...
export const board = [
  ...
  },
  {
    ...
    href: "/faculties?department=arts-fine-arts#arts",
  },
  {
    role: "政治経済",
    name: "ろーと",
  ...
  },
  {
    ...
    href: "/campus?highlight=counselor#counseling",
  },
];
