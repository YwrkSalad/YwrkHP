const BOT_PATTERN = new RegExp(
  [
    // 汎用キーワード
    "bot", "crawler", "spider", "crawl", "scraper", "scrape",
    // ヘッドレス・自動化
    ...
    "seznambot", "blexbot", "sistrix",
    // AI クローラー
    "gptbot", "claudebot", "anthropic-ai", "ccbot", "chatgpt-user",
    ...
    "node-fetch", "go-http-client", "java/", "libwww", "okhttp",
    "httpie", "httpx",
  ].join("|"),
  "i",
);
