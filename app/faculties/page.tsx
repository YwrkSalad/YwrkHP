      ...
      <main className="pt-[4.5rem]">
        ...
        <PageSection id="graduate" className="bg-accent-900 py-24">
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            {/* 研究科 1 */}
            <ScrollReveal delay={0.1}>
              <div className="rounded-md border border-white/15 bg-zinc-950/55 p-8">
                ...
                <div className="mb-5 space-y-2">
                  {[
                    ...
                    <div
                      key={c.course}
                      className="rounded border border-white/15 bg-zinc-900/45 px-4 py-3"
                    >
                      ...
                      <p className="text-xs text-zinc-100">{c.desc}</p>
                    </div>
                  ))}
                </div>
          ...
          <ScrollReveal delay={0.25}>
            <div className="mt-8 rounded-md border border-white/15 bg-zinc-950/55 p-8">
              ...
              <ul className="grid gap-2 text-sm text-zinc-100 sm:grid-cols-2">
                {[
                  ...
                  <li key={item} className="flex items-start gap-2">
                    <span className="text-accent-300 mt-0.5 shrink-0">▸</span>
                    {item}
                  </li>
                ))}
              </ul>
