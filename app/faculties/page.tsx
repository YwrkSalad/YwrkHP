...
const faculties = [
  {
    ...
    description:
      "数学・物理学・化学・生物学・地球惑星科学の5学科で構成される理学部。基礎科学の深化を通じて自然界の本質を探究し、科学的思考力と論理的表現力を備えた研究者・技術者を育成します。",
    departments: [
      { name: "数学科", body: "代数・解析・幾何・数理統計を基礎から研究し、現代数学の最前線へ。" },
      { name: "物理学科", body: "量子力学・統計力学・素粒子物理から凝縮系物理まで幅広く探究する。" },
      { name: "化学科", body: "有機・無機・物理・生物化学を網羅し、分子レベルで物質の本質に迫る。" },
      { name: "生物学科", body: "細胞・分子生物学から生態学まで、生命現象を多階層で解明する。" },
      { name: "地球惑星科学科", body: "地質・海洋・大気・惑星を対象に、地球システム科学を総合的に学ぶ。" },
    ],
  },
  {
    id: "engineering",
    ...
    departments: [
      { name: "機械航空工学科", body: "熱流体・固体力学・制御工学・ロボティクスおよび航空宇宙工学を専攻する。" },
      { name: "電気情報工学科", body: "電気回路・電磁気・半導体・通信工学・組み込みシステムを体系的に学ぶ。" },
      { name: "建設環境工学科", body: "構造・地盤・水工・交通・環境工学を学び、社会インフラの設計・維持を担う。" },
      { name: "化学システム工学科", body: "反応工学・移動現象・プロセス設計を通じて化学産業の技術革新を追求する。" },
      { name: "材料科学工学科", body: "金属・セラミックス・高分子・複合材料の構造と機能を原子レベルで解明する。" },
    ],
  },
  {
    id: "agriculture",
    ...
    departments: [
      { name: "農業科学科", body: "作物・土壌・農業生態系を科学し、持続可能な食料生産システムを研究する。" },
      { name: "生命機能科学科", body: "植物・動物の生理・遺伝・分子育種を通じ、生命機能の制御に迫る。" },
      { name: "資源生物科学科", body: "水産・畜産・森林など生物資源の増産・保全・利用技術を探究する。" },
      { name: "応用生物化学科", body: "食品化学・醸造・バイオテクノロジーを基礎に農産物の機能と利用を研究する。" },
    ],
  },
  {
    ...
    departments: [
      { name: "情報工学科", body: "アルゴリズム・OS・コンパイラ・ネットワーク・セキュリティの基盤技術を習得する。" },
      { name: "知能情報工学科", body: "機械学習・深層学習・自然言語処理・コンピュータビジョンを研究・開発する。" },
      { name: "生体情報工学科", body: "バイオインフォマティクス・医用画像・神経情報工学で生命と情報を融合させる。" },
      { name: "数理情報科学科", body: "確率論・最適化・暗号理論・情報理論の数理的基盤から応用まで深く学ぶ。" },
    ],
  },
  {
    id: "medicine",
    ...
    departments: [
      { name: "医学科", body: "解剖・生理・病理・内科・外科・精神科など医学全領域を6年間で体系的に修める。" },
      { name: "保健学科", body: "看護・放射線・検査・理学療法の4専攻で、チーム医療を支える保健専門職を育てる。" },
    ],
  },
];
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              ...
              <ScrollReveal delay={0.1}>
                <div className="rounded-md border border-accent-700 bg-accent-800 p-8">
                  ...
                  <div className="mb-5 space-y-2">
                    {[
                      { course: "修士課程", years: "2年", desc: "数理物理専攻 / 機械電気システム専攻 / 情報知能専攻" },
                      { course: "博士課程", years: "3年", desc: "先端科学技術専攻 / 計算科学専攻" },
                    ].map((c) => (
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["国際誌掲載 40+件/年", "量子計算", "深層学習", "ロボティクス", "マテリアルズインフォマティクス"].map((t) => (
              ...
              <ScrollReveal delay={0.18}>
                <div className="rounded-md border border-accent-700 bg-accent-800 p-8">
                  ...
                  <div className="mb-5 space-y-2">
                    {[
                      { course: "修士課程", years: "2年", desc: "農業生命科学専攻 / 応用生物化学専攻 / 医科学専攻" },
                      { course: "博士課程", years: "3年", desc: "生命農学統合科学専攻 / 医学系研究専攻" },
                    ].map((c) => (
                      <div key={c.course} className="rounded bg-accent-700/50 px-4 py-3">
                        <div className="flex items-center gap-2 mb-1">
                          <span className="text-xs font-semibold text-accent-300">{c.course}</span>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {["国際誌掲載 40+件/年", "バイオインフォマティクス", "ゲノム医学", "食品機能科学", "環境毒性学"].map((t) => (
                      <span key={t} className="rounded border border-accent-600 px-2 py-0.5 text-xs text-accent-300">{t}</span>
                    ))}
                  </div>
                </div>
